/**
 * Created by ZuoXiaoFei on 2018.8.28.
 */
import * as React from 'react';
import { View, Platform } from 'react-native';
import { polyfill } from 'react-lifecycles-compat';
import { TabView, PagerPan } from 'react-native-tab-view';
import createTabNavigator from 'react-navigation-tabs/dist/utils/createTabNavigator';
import MaterialTopTabBar from 'react-navigation-tabs/dist/views/MaterialTopTabBar';
...
class MaterialTabView extends React.PureComponent {
  ...
  render() {
    ...
    return <TabView {...rest}
                    ...
                    tabBarPosition="bottom" renderScene={
      /* $FlowFixMe */
      this._renderScene} />;
  }
}
